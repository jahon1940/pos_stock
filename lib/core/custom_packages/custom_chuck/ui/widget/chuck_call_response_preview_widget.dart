// ignore_for_file: use_key_in_widget_constructors, prefer_single_quotes
...
import '../../ui/widget/chuck_json_viewer.dart';
  ...
  List<Widget> _buildLargeBodyTextRows() {
    ...
    if (_showLargeBody) {
      ...
      rows.add(
        ElevatedButton(
          style: ButtonStyle(
            backgroundColor: MaterialStateProperty.all<Color>(ChuckConstants.lightRed),
          ),
          onPressed: () {
            setState(() {
              _showLargeBody = true;
