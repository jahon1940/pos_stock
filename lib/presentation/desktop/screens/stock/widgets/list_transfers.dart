...
class TransfersList extends StatelessWidget {
  const TransfersList(
      {super.key, required this.admission, this.onDelete, required this.stock, required this.organization});
  ...
  Widget build(
    BuildContext context,
      ...
      TableProductItem(
        ...
        onTap: () async {
          await router.push(AddTransferRoute(transfer: admission, stock: stock, organization: organization));
        },
        children: [
          SizedBox(
            height: 60,
