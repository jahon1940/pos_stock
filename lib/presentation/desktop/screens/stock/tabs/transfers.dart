...
import 'package:hoomo_pos/presentation/desktop/screens/stock/widgets/list_transfers.dart';
...
class Transfers extends HookWidget {
  const Transfers(
    this.stock,
    this.organization, {
    super.key,
  ...
  Widget build(BuildContext context) {
    useEffect(() {
      context.read<StockBloc>().add(StockEvent.searchTransfers(stock.id, true));
      return null;
    }, const []);
                          ...
                          child: state.transfers?.results == []
                              ...
                              : ListView.separated(
                                  ...
                                  separatorBuilder: (context, index) =>
                                      AppSpace.vertical12,
                                  itemCount:
                                      state.transfers?.results.length ?? 0,
                                ),
                        );
                      }
