    ...
    return Padding(
      ...
      child: TableProductItem(
        columnWidths: {
          ...
          if (!editable) 2: const FlexColumnWidth(3),
          if (!editable) 3: const FlexColumnWidth(2),
          if (editable) 4: const FlexColumnWidth(2),
        },
        onTap: () {},
        children: [
          SizedBox(
          ...
          if (!editable)
            SizedBox(
              ...
              child: Padding(
                  padding: const EdgeInsets.all(8),
                  child: Center(child: Text(product?.realQuantity.toString() ?? '0'))),
            ),
          if (!editable)
            SizedBox(
              height: 60,
              ...
              child: Padding(
                  padding: const EdgeInsets.all(8),
                  child: Center(child: Text(product?.quantityDiff.toString() ?? '0'))),
            ),
          if (editable)
            SizedBox(
              width: 50,
