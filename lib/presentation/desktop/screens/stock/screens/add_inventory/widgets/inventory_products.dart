                        ...
                        children: [
                          ...
                          GestureDetector(
                            onTap: () async {
                              context
                                  .read<StockBloc>()
                                  .add(StockEvent.downloadInventory(
                                    state.Inventory!.id,
                                  ));
                            },
                ...
                SizedBox(
                  ...
                  child: TableTitleProducts(
                    ...
                    columnWidths: {
                      0: FlexColumnWidth(5),
                      1: FlexColumnWidth(2),
                      if (state.products != null) 2: FlexColumnWidth(3),
                      if (state.products != null) 3: FlexColumnWidth(2),
                      if (state.products == null) 4: FlexColumnWidth(2),
                    },
                    titles: [
                    ...
                    itemBuilder: (context, index) => AddInventoryProductList(
                        ...
                        product: state.products != null
                            ? InventoryProductRequest(
                                ...
                                realQuantity:
                                    state.products?[index].realQuantity ?? 0,
                                oldQuantity:
                                    state.products?[index].oldQuantity ?? 0,
                                price: state.products?[index].price,
                                priceDiff:
                                    state.products?[index].priceDiff ?? 0,
                                quantityDiff:
                                    state.products?[index].quantityDiff ?? 0,
                              )
