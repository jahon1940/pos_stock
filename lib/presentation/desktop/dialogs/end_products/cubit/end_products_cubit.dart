...
part 'end_products_state.dart';

part 'end_products_cubit.freezed.dart';

@injectable
class EndProductsCubit extends Cubit<EndProductsState> {
  EndProductsCubit(this._repository) : super(EndProductsState());
  ...
  void init(bool value) async {
    try {
      ...
      final res = await _repository.getLowDemandProducts(1, value);
  ...
  void loadMore(bool value) async {
    try {
      ...
      final res = await _repository.getLowDemandProducts(state.page + 1, value);
