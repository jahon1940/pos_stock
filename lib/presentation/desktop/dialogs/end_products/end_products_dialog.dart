...
class EndProductsDialog extends HookWidget {
  const EndProductsDialog({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    useEffect(() {
      context.read<EndProductsCubit>().init(true);
      scrollController.addListener(() {
        if (scrollController.position.pixels >=
            scrollController.position.maxScrollExtent - 200) {
          context.read<EndProductsCubit>().loadMore(selectedValue.value);
        }
      });
      return null;
    }, const []);
          ...
          child: SizedBox(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Expanded(
                    flex: 10,
                    child: BlocBuilder<EndProductsCubit, EndProductsState>(
